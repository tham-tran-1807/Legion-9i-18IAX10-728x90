...
lib.ssMetadata = [
		{name:"Legion_9i_18IAX10_728x90_atlas_1", frames: [[803,184,50,50],[0,0,728,90],[0,92,528,90],[0,184,463,90],[0,276,450,90],[530,92,349,90],[465,184,336,90],[0,368,421,90],[423,368,428,86]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Legion_9i_18IAX10_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.Legion9i18IAX10728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(301).call(this.frame_301).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(300).to({_off:false},0).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(300).to({_off:false},0).to({y:10.45},12).wait(18));

	// clickTag_btn
	this.clickTag_btn = new lib.clickTag_btn();
	this.clickTag_btn.name = "clickTag_btn";
	this.clickTag_btn.setTransform(364,45,1,1,0,0,0,364,45);
	new cjs.ButtonHelper(this.clickTag_btn, 0, 1, 2, false, new lib.clickTag_btn(), 3);

	this.timeline.addTween(cjs.Tween.get(this.clickTag_btn).wait(330));

	// F7
	this.instance = new lib.F7();
	this.instance.setTransform(110,4);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(299).to({_off:false},0).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(250).to({_off:false},0).to({_off:true},49).wait(31));

	// F5
	this.instance_2 = new lib.F5();
	this.instance_2.setTransform(196,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(199).to({_off:false},0).to({_off:true},51).wait(80));

	// F4
	this.instance_3 = new lib.F4();
	this.instance_3.setTransform(196,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(150).to({_off:false},0).to({_off:true},49).wait(131));

	// F3
	this.instance_4 = new lib.F3();
	this.instance_4.setTransform(173,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(99).to({_off:false},0).to({_off:true},51).wait(180));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(50).to({_off:false},0).to({_off:true},49).wait(231));

	// F1
	this.instance_6 = new lib.F1();
	this.instance_6.setTransform(142,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},50).wait(280));

	// Bg
	this.instance_7 = new lib.Bg();

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(330));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(364,29.5,364,60.5);
// library properties:
lib.properties = {
	id: 'AE49147C1ED8DC48BFAF7132DC06E3F2',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Legion_9i_18IAX10_728x90_atlas_1.png", id:"Legion_9i_18IAX10_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['AE49147C1ED8DC48BFAF7132DC06E3F2'] = {
